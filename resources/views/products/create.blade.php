                    ...
                    <form enctype="multipart/form-data" action={{route('products.store')}} method="POST" >
                        ...
                        <div class="card-body">
                            <div class="mb-2">
                                ...
                                <input type="text" value="{{old('name')}}" name="name" class="@error('name') is-invalid @enderror       form-control " placeholder="name">
                                @error('name')
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" value="{{old('sku')}}" name="sku" class="@error('sku') is-invalid @enderror form-control  " placeholder="Enter name">
                                @error('sku')
                                    <p class="invalid-feedback">{{$message}}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <textarea type="text" name="description" class="form-control resize-0 " placeholder="Enter Description">{{old('description')}}</textarea>
                            </div>
